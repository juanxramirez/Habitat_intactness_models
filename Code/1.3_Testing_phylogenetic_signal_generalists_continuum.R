...
vars <- c("order", "family", "genus", "continuum_p95", 
          "range_size", "gestation_length", "weaning_age", "rl_cat")
phylo_data_model <- phylo_data[, vars]
colnames(phylo_data_model) <- c("or", "fam", "gen", "cm", "rs", "gl", "wa", "rl.cat")
...
residuals_vector <- residuals(cm.glmer, type="response")
