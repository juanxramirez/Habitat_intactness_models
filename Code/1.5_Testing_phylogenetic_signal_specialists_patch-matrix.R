...
vars <- c("order", "family", "genus", "patch_matrix", 
          "range_size", "gestation_length", "weaning_age", "rl_cat")
phylo_data_model <- phylo_data[, vars]
colnames(phylo_data_model) <- c("or", "fam", "gen", "pm", "rs", "gl", "wa", "rl.cat")
