...
ext.risk.mammals.data<-data.frame(or=threatened.under.criterionB.excluded.na.omit$order,
                                  ...
                                  cm=threatened.under.criterionB.excluded.na.omit$continuum_p50,
                                  ...
                                  rlm=threatened.under.criterionB.excluded.na.omit$realm,
...
#----
# ER ~ pm
hc.pm.but.afrotropic<-glmer(rl.cat~pm+rs+gl+wa+(1|or), family=binomial, data=train.but.afrotropic, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
hc.pm.but.australasia<-glmer(rl.cat~pm+rs+gl+wa+(1|or), family=binomial, data=train.but.australasia, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
hc.pm.but.indomalayan<-glmer(rl.cat~pm+rs+gl+wa+(1|or), family=binomial, data=train.but.indomalayan, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
hc.pm.but.nearctic<-glmer(rl.cat~pm+rs+gl+wa+(1|or), family=binomial, data=train.but.nearctic, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
hc.pm.but.neotropic<-glmer(rl.cat~pm+rs+gl+wa+(1|or), family=binomial, data=train.but.neotropic, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
hc.pm.but.palearctic<-glmer(rl.cat~pm+rs+gl+wa+(1|or), family=binomial, data=train.but.palearctic, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
...
#----
# ER ~ cm
hc.cm.but.afrotropic<-glmer(rl.cat~cm+rs+gl+wa+(1|or), family=binomial, data=train.but.afrotropic, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
hc.cm.but.australasia<-glmer(rl.cat~cm+rs+gl+wa+(1|or), family=binomial, data=train.but.australasia, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
hc.cm.but.indomalayan<-glmer(rl.cat~cm+rs+gl+wa+(1|or), family=binomial, data=train.but.indomalayan, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
hc.cm.but.nearctic<-glmer(rl.cat~cm+rs+gl+wa+(1|or), family=binomial, data=train.but.nearctic, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
hc.cm.but.neotropic<-glmer(rl.cat~cm+rs+gl+wa+(1|or), family=binomial, data=train.but.neotropic, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
hc.cm.but.palearctic<-glmer(rl.cat~cm+rs+gl+wa+(1|or), family=binomial, data=train.but.palearctic, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
...
#----
# ER ~ hm
hc.hm.but.afrotropic<-glmer(rl.cat~hm+rs+gl+wa+(1|or), family=binomial, data=train.but.afrotropic, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
hc.hm.but.australasia<-glmer(rl.cat~hm+rs+gl+wa+(1|or), family=binomial, data=train.but.australasia, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
hc.hm.but.indomalayan<-glmer(rl.cat~hm+rs+gl+wa+(1|or), family=binomial, data=train.but.indomalayan, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
hc.hm.but.nearctic<-glmer(rl.cat~hm+rs+gl+wa+(1|or), family=binomial, data=train.but.nearctic, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
hc.hm.but.neotropic<-glmer(rl.cat~hm+rs+gl+wa+(1|or), family=binomial, data=train.but.neotropic, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
hc.hm.but.palearctic<-glmer(rl.cat~hm+rs+gl+wa+(1|or), family=binomial, data=train.but.palearctic, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=100000)))
...
write.table(auc.pmcmhm, file="auc_spatially_blocked_cv_pmcmhm_specialists_threatened_criterionB_excluded.csv", sep="\t", row.names=F)
