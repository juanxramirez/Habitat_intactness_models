...
data.generalists<-data.frame(or=generalists.gain.excluded.na.omit$order,
                         cp5=generalists.gain.excluded.na.omit$continuum_p5,
                         cp10=generalists.gain.excluded.na.omit$continuum_p10,
                         cp50=generalists.gain.excluded.na.omit$continuum_p50,
                         cp90=generalists.gain.excluded.na.omit$continuum_p90,
                         cp95=generalists.gain.excluded.na.omit$continuum_p95,
                         rcp5=generalists.gain.excluded.na.omit$change_continuum_p5,
                         rcp10=generalists.gain.excluded.na.omit$change_continuum_p10,
                         rcp50=generalists.gain.excluded.na.omit$change_continuum_p50,
                         rcp90=generalists.gain.excluded.na.omit$change_continuum_p90,
                         rcp95=generalists.gain.excluded.na.omit$change_continuum_p95,
                         hp5=generalists.gain.excluded.na.omit$hybrid_p5,
                         hp10=generalists.gain.excluded.na.omit$hybrid_p10,
                         hp50=generalists.gain.excluded.na.omit$hybrid_p50,
                         hp90=generalists.gain.excluded.na.omit$hybrid_p90,
                         hp95=generalists.gain.excluded.na.omit$hybrid_p95,
						             rhp5=generalists.gain.excluded.na.omit$change_hybrid_p5,
                         rhp10=generalists.gain.excluded.na.omit$change_hybrid_p10,
                         rhp50=generalists.gain.excluded.na.omit$change_hybrid_p50,
                         rhp90=generalists.gain.excluded.na.omit$change_hybrid_p90,
                         rhp95=generalists.gain.excluded.na.omit$change_hybrid_p95,
...
cp5.glmer<-glmer(rl.cat~cp5+rcp5+rs+gl+wa+(1|or), family=binomial, data=data.generalists.scaled)
cp10.glmer<-glmer(rl.cat~cp10+rcp10+rs+gl+wa+(1|or), family=binomial, data=data.generalists.scaled)
cp50.glmer<-glmer(rl.cat~cp50+rcp50+rs+gl+wa+(1|or), family=binomial, data=data.generalists.scaled)
cp90.glmer<-glmer(rl.cat~cp90+rcp90+rs+gl+wa+(1|or), family=binomial, data=data.generalists.scaled)
cp95.glmer<-glmer(rl.cat~cp95+rcp95+rs+gl+wa+(1|or), family=binomial, data=data.generalists.scaled)
...
hp5.glmer<-glmer(rl.cat~hp5+rhp5+rs+gl+wa+(1|or), family=binomial, data=data.generalists.scaled)
hp10.glmer<-glmer(rl.cat~hp10+rhp10+rs+gl+wa+(1|or), family=binomial, data=data.generalists.scaled)
hp50.glmer<-glmer(rl.cat~hp50+rhp50+rs+gl+wa+(1|or), family=binomial, data=data.generalists.scaled)
hp90.glmer<-glmer(rl.cat~hp90+rhp90+rs+gl+wa+(1|or), family=binomial, data=data.generalists.scaled)
hp95.glmer<-glmer(rl.cat~hp95+rhp95+rs+gl+wa+(1|or), family=binomial, data=data.generalists.scaled)
