...
# Export Fig.S3
png("Fig.S3.png", units="in", width=3, height=4, res=1200, type="cairo")
...
# Extract legend
legend.fig.S6 <- get_legend(
  pmcmhm.effectsize.criterionB.includedvsexcluded.plot + 
    theme(legend.position = "bottom")
)

# Export Fig.S6
png("Fig.S6.png", units="in", width=3, height=6.3, res=1200, type="cairo")
plot_grid(pmcmhm.effectsize.criterionB.includedvsexcluded.plot.fv, legend.fig.S6, ncol = 1, rel_heights = c(1, .1))
dev.off()
