...
data.specialists<-data.frame(or=specialists.gain.excluded.na.omit$order,
                             cp5=specialists.gain.excluded.na.omit$continuum_p5,
                             cp10=specialists.gain.excluded.na.omit$continuum_p10,
                             cp50=specialists.gain.excluded.na.omit$continuum_p50,
                             cp90=specialists.gain.excluded.na.omit$continuum_p90,
                             cp95=specialists.gain.excluded.na.omit$continuum_p95,
                             rcp5=specialists.gain.excluded.na.omit$change_continuum_p5,
                             rcp10=specialists.gain.excluded.na.omit$change_continuum_p10,
                             rcp50=specialists.gain.excluded.na.omit$change_continuum_p50,
                             rcp90=specialists.gain.excluded.na.omit$change_continuum_p90,
                             rcp95=specialists.gain.excluded.na.omit$change_continuum_p95,
                             hp5=specialists.gain.excluded.na.omit$hybrid_p5,
                             hp10=specialists.gain.excluded.na.omit$hybrid_p10,
                             hp50=specialists.gain.excluded.na.omit$hybrid_p50,
                             hp90=specialists.gain.excluded.na.omit$hybrid_p90,
                             hp95=specialists.gain.excluded.na.omit$hybrid_p95,
                             rhp5=specialists.gain.excluded.na.omit$change_hybrid_p5,
                             rhp10=specialists.gain.excluded.na.omit$change_hybrid_p10,
                             rhp50=specialists.gain.excluded.na.omit$change_hybrid_p50,
                             rhp90=specialists.gain.excluded.na.omit$change_hybrid_p90,
                             rhp95=specialists.gain.excluded.na.omit$change_hybrid_p95,
...
#----
# ER ~ continuum (c) + reduction in continuum (rc) + ...
cp5.glmer<-glmer(rl.cat~cp5+rcp5+rs+gl+wa+(1|or), family=binomial, data=data.specialists.scaled)
cp10.glmer<-glmer(rl.cat~cp10+rcp10+rs+gl+wa+(1|or), family=binomial, data=data.specialists.scaled)
cp50.glmer<-glmer(rl.cat~cp50+rcp50+rs+gl+wa+(1|or), family=binomial, data=data.specialists.scaled)
cp90.glmer<-glmer(rl.cat~cp90+rcp90+rs+gl+wa+(1|or), family=binomial, data=data.specialists.scaled)
cp95.glmer<-glmer(rl.cat~cp95+rcp95+rs+gl+wa+(1|or), family=binomial, data=data.specialists.scaled)
...
#----
# ER ~ hybrid (h) + reduction in hybrid (rh) + ...
hp5.glmer<-glmer(rl.cat~hp5+rhp5+rs+gl+wa+(1|or), family=binomial, data=data.specialists.scaled)
hp10.glmer<-glmer(rl.cat~hp10+rhp10+rs+gl+wa+(1|or), family=binomial, data=data.specialists.scaled)
hp50.glmer<-glmer(rl.cat~hp50+rhp50+rs+gl+wa+(1|or), family=binomial, data=data.specialists.scaled)
hp90.glmer<-glmer(rl.cat~hp90+rhp90+rs+gl+wa+(1|or), family=binomial, data=data.specialists.scaled)
hp95.glmer<-glmer(rl.cat~hp95+rhp95+rs+gl+wa+(1|or), family=binomial, data=data.specialists.scaled)
